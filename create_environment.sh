...
coco,Shell Navigation,not submitted
Peggy,Shell Navigation,submitted
Eva,Shell Navigation,not submitted
Mike,Shell Navigation,not submitted
Mwami,Shell Navigation,submitted
Tom,Shell Navigation,submitted
Cyuzuzo,Shell Navigation,not submitted
EOF
...
# Display assignment details from the env variables
echo "Assignment: $ASSIGNMENT"
echo "Days remaining to submit: $DAYS_REMAINING days"
echo "----------------------------------------------"
